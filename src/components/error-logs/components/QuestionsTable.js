            ...
            {data.length > 0 &&
              data?.map((row, idx) => {
                const sectionColors = getSectionColor(
                  row?.questionData?.section
                );
                return (
                  <TableRow
                    key={row?.questionData?.questionNumber || idx}
                    sx={{
                      "&:hover": {
                  ...
                  >
                    <TableCell sx={{ py: 2 }}>
                      <Box
                        sx={{
                          ...
                          borderRadius: "50%",
                          background: "white",
                          color: row?.questionData?.isCorrect
                            ? "#2e7d32"
                            : "#d32f2f",
                          fontWeight: 700,
                          fontSize: "1rem",
                      ...
                      >
                        ...
                        <Typography
                          ...
                          fontWeight={700}
                        >
                          : {row?.questionData?.module}
                        </Typography>
                      </Box>
                    </TableCell>
                    <TableCell sx={{ py: 2 }}>
                      <Chip
                        label={sectionName(row?.questionData?.section)}
                        sx={{
                    ...
                    <TableCell sx={{ py: 2 }}>
                      ...
                      >
                        {Array.isArray(row?.questionData?.correctAnswer)
                          ? row?.questionData?.correctAnswer.join(";")
                          : row?.questionData?.correctAnswer}
                      </Box>
                    </TableCell>
                    <TableCell sx={{ py: 2 }}>
                      {row?.questionData?.yourAnswer ? (
                        <Box
                          sx={{
                            display: "inline-flex",
                            alignItems: "center",
                    ...
                    <TableCell sx={{ py: 2 }}>
                      ...
                      >
                        {getAnswerStatusIcon(row?.questionData?.isCorrect)}
                        <Typography
                          variant="body2"
                          sx={{
                            color: row?.questionData?.isCorrect
